...
local ValidEntity = function(a) return a.GetId ~= nil end
local error = error
local print = print
local setmetatable = setmetatable
local Vector = Vec3
local Angle = Ang3
local Entity = entities.GetbyId
local EffectData = EffectData
local GetConVar = GetConVar
local tonumber = tonumber
local player = entities
local IsValid = ValidEntity
module("glon")
local encode_types
local decode_types
...
encode_types = {
	...
	entity = {10, function(o)
		return (ValidEntity(o) and o:GetId() or -1).."\1"
	end},
	actor = {10, function(o)
		return (ValidEntity(o) and o:GetId() or -1).."\1"
	end},
	...
	physics = {14, function(o)
		local parent = o:GetEntity()
		return parent:GetId().."\1"..id.."\1"
	end},
	color = {15, function(o)
