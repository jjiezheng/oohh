...
hook.Add("PlayerSay", "gmod_xchat", function(ply, msg)
	local clt = luasocket.Client()
	clt:Connect("88.191.111.120", 37475)
	clt:Send("xc\n" .. glon.encode
		{
			event = "say",
			ply = ply:GetNickname(),
			plyc = {r=130, g=150, b=200},
			msg = msg,
			id = "oh",
		}
	)
