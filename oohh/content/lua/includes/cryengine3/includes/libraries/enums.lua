...
OS_ALPHA_BLEND = 0x1
OS_ADD_BLEND = 0x2
OS_MULTIPLY_BLEND = 0x4
OS_TRANSPARENT = bit.bor(OS_ALPHA_BLEND, OS_ADD_BLEND, OS_MULTIPLY_BLEND)
OS_NODEPTH_TEST = 0x8
OS_DIFFUSE_CUBEMAP = 0x10
OS_ANIM_BLEND = 0x20
...
SRF_SCREENTARGET = 1
SRF_USE_ORIG_DEPTHBUF = 2
SRF_USE_ORIG_DEPTHBUF_MSAA = 4
...
FT_FILESINGLE = 0x20				-- suppress loading of additional files like _DDNDIF (faster, RC can tag the file for that)
FT_TEX_FONT = 0x40
FT_HAS_ATTACHED_ALPHA = 0x80
--FT_DONTSYNCMULTIGPU = 0x100				-- through NVAPI we tell driver not to sync
FT_USAGE_READBACK = 0x200
FT_USAGE_MSAA = 0x400
FT_FORCE_MIPS = 0x800
FT_USAGE_RENDERTARGET = 0x1000
FT_USAGE_DYNAMIC = 0x2000
FT_DONT_RESIZE = 0x4000
FT_CUSTOM_FORMAT = 0x8000
FT_DONT_RELEASE = 0x10000
FT_DONT_GENNAME = 0x20000
FT_DONT_STREAM = 0x40000
FT_USAGE_PREDICATED_TILING = 0x80000
FT_FAILED = 0x100000
...
FT_USAGE_VERTEX_BUFFER		= 0x4000000
FT_SPLITTED = 0x8000000	-- for splitted dds files
FT_FILTER_POINT = 0x10000000
FT_FILTER_LINEAR = 0x20000000
FT_FILTER_BILINEAR = 0x30000000
FT_FILTER_TRILINEAR = 0x40000000
FT_FILTER_ANISO2 = 0x50000000
FT_FILTER_ANISO4 = 0x60000000
FT_FILTER_ANISO8 = 0x70000000
FT_FILTER_ANISO16 = 0x80000000
FT_FILTER_MASK = 0xf0000000
